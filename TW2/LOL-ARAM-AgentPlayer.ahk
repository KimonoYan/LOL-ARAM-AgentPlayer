...
if(GetColor(961,668)=="0x1B2566" || GetColor(968,539)=="0xF2E0C3")		;;专精等级，level up跳过
{
...
; 判断是否死亡，如果死亡状态，按P购物
	if( IsColorSeems(443,1012, "0x010D06") && ( IsColorSeems(441,1029, "0x010304") || GetColor(434,1029)=="0x000000" ) )
	{
		...
		MouseGetPos, mouseX, mouseY
		MouseClick, middle, 360,540,0
		; 归还鼠标指针
		MouseClick, middle, %mouseX%, %mouseY%,0
		sleep 300 
		Click, Left
		sleep 100
		Click, Left
...
; 搜索敌人并移动鼠标: if未找到目标-移动，else找到目标-攻击  0x380502
	...
	if (ErrorLevel != 0)
	{
		...
		if(MoveFlag == 0)
		{
			MouseClick, middle, (DefaultposX-20),(DefaultposY-40),0
		}
		else if(MoveFlag == 1)
		{
			MouseClick, middle, (DefaultposX-80),(DefaultposY+20),0
		}
		else if(MoveFlag == 2)
		{
			MouseClick, middle, (DefaultposX+55),(DefaultposY+20),0
		}
	...
	else
	{
		...
		;else{
			...
			MouseClick, X2, targetX,targetY, 1,U		; 规避方式2：使用 fifth Btn，目的是要绑定一个按键用来锁敌
...
Action:
   ...
   IfWinExist, League of Legends (TM) Client;
   {
	...
	;MsgBox, 未找到游戏
       	;WinSet, AlwaysOnTop, , League of Legends
